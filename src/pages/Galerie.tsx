...
/* ─── DISH CARD ─────────────────────────────────────────── */
function DishCard({ dish, onClick }: { dish: Dish; onClick: (d: Dish) => void }) {
...
export default function Galerie() {
  ...
  const filtered = dishes.filter(d => {
    ...
    const matchRegion  = activeRegion === 'Tous' || (REGIONS as Record<string, string[]>)[activeRegion]?.includes(d.country)
