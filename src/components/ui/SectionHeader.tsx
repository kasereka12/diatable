interface Props { label: string; title: string; light?: boolean; centered?: boolean }

export default function SectionHeader({ label, title, light = false, centered = true }: Props) {
  return (
