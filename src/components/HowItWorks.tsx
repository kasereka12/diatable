...
export default function HowItWorks() {
  ...
  const STEPS = [
    { num: '01', Icon: Search, title: t('how.step1_title'), desc: t('how.step1_desc') },
    { num: '02', Icon: MapPin, title: t('how.step2_title'), desc: t('how.step2_desc') },
    { num: '03', Icon: Utensils, title: t('how.step3_title'), desc: t('how.step3_desc') },
  ]
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden" style={{ backgroundColor: '#1f1f1f' }} ref={ref}>
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        <SectionHeader label={t('how.label')} title={t('how.title')} light />
