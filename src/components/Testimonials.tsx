...
interface Testimonial { id: string | number; rating: number; text: string; initials: string; name: string; origin: string }
interface TestimonialCardProps { t: Testimonial; delay?: string }

function TestimonialCard({ t, delay = '0s' }: TestimonialCardProps) {
  return (
    <div
      data-reveal
      data-delay={delay}
