...
interface PlaceResult { address: string; lat: number; lng: number; quartier: string }
interface Props {
  value: string
...
export default function AddressAutocomplete({ value, onChange, onPlaceSelect }: Props) {
  ...
  const autocompleteRef = useRef<any | null>(null) // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  function initAutocomplete() {
    ...
    autocompleteRef.current.addListener('place_changed', () => {
      ...
      function extractQuartier(components: any) {
